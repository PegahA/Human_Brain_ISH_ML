...
def get_embeddings_from_pre_trained_model_2(model_name="resnet50", trained_on="imagenet", dim=128, standardize=False):
...
if __name__ == '__main__':
    ...
    get_embeddings_from_pre_trained_model_2(standardize=True)
